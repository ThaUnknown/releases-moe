...
document.head.insertAdjacentHTML('beforeend', '<style id="css_purple" type="text/css">.best-alt > td {background-color: rgba(188, 30, 157, 0.4) !important;} .best-alt:hover > td {background-color: rgba(188, 30, 157, 0.48) !important;} .panel-best-alt, .panel-best-alt > .panel-heading {border-color: rgba(188, 30, 157, 0.4) !important;} .panel-best-alt > .panel-heading {background-color: rgba(188, 30, 157, 0.4) !important;} .panel-success.panel-best-alt > .panel-heading {color: unset;}</style>')
