...
<div>
  ...
  <ul class='list-disc list-inside py-4'>
    ...
    <li><a href={`${origin}/api/collections/entries/records?sort=@random&perPage=1`} target='_blank' class='text-blue-600 dark:text-blue-500 hover:underline'>Get an entry for a specific AniList ID</a></li>
